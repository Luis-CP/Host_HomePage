...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <div class="profile-sidebar">
        <div class="profile-usertitle">
            ...
            <div class="profile-usertitle-status" style="font-family: cursive;"><span
                        class="indicator label-success"></span>Sistema
            </div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <ul class="nav menu">
        ...
        <li><a href="../Medidor/lista.php"><em class="fa fa-clone">&nbsp;</em> Medidores </a></li>
        <li><a href="../Cartolas/crear.php"><em class="fa fa-book">&nbsp;</em> Cartolas </a></li>
        <li class=""><a href="lista.php"><em class="fa fa-bookmark">&nbsp;</em> Pagos </a></li>
        <li class=""><a href="reportes.php"><em class="fa fa-bookmark">&nbsp;</em> Reportes </a></li>
